        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ControllerName = table.Column<string>(type: "nvarchar(450)", nullable: true, defaultValue: ""),
                    ActionName = table.Column<string>(type: "nvarchar(450)", nullable: true, defaultValue: ""),
                    ClaimType = table.Column<string>(type: "nvarchar(450)", nullable: true, defaultValue: ""),
                    ClaimValue = table.Column<string>(type: "nvarchar(450)", nullable: true, defaultValue: ""),
                    DisplayName = table.Column<string>(type: "nvarchar(450)", nullable: true, defaultValue: ""),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetRoles_Auth_Domains_DomainId",
                        column: x => x.DomainId,
                        principalTable: "Auth_Domains",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
