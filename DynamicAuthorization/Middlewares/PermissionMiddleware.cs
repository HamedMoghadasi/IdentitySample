...
using DynamicAuthorization.Constants;
using Microsoft.AspNetCore.Http;
using Microsoft.AspNetCore.Mvc.Controllers;
using DynamicAuthorization.Core;

namespace DynamicAuthorization.Middlewares
{
    ...
    public class PermissionMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext httpContext, UserManager<IdentityUser> userManager, RoleManager<IdentityRole> roleManager, IAuthorizationDbContext _context)
        {
